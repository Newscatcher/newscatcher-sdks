...
namespace Newscatcherapi.Net.Model
{
    ...
    public partial class Page : AbstractOpenAPISchema, IEquatable<Page>, IValidatableObject
    {
        /// <summary>
        ...
        public Page(string actualInstance)
        {
        ...
        public Page(int actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "anyOf";
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, Page.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of Page
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of Page</returns>
        public static Page FromJson(string jsonString)
        {
            Page newPage = null;
            ...
            try
            {
                newPage = new Page(JsonConvert.DeserializeObject<int>(jsonString, Page.SerializerSettings));
            ...
            try
            {
                newPage = new Page(JsonConvert.DeserializeObject<string>(jsonString, Page.SerializerSettings));
                // deserialization is considered successful at this point if no exception has been thrown.
                return newPage;
            }
            catch (Exception exception)
    ...
    /// <summary>
    /// Custom JSON converter for Page
    /// </summary>
    public class PageJsonConverter : JsonConverter
    {
        ...
        {
            writer.WriteRawValue((string)(typeof(Page).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return Page.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
