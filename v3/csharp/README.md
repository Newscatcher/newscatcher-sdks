...
[![NuGet](https://img.shields.io/badge/NuGet-6.0.13-blue.svg)](https://www.nuget.org/packages/Newscatcherapi.Net/6.0.13)
...
## Documentation for Models
 ...
 - [ByParseDate](docs/ByParseDate.md)
 - [Cluster](docs/Cluster.md)
 - [ClusteringEnabled](docs/ClusteringEnabled.md)
 - [ClusteringSearchResponse](docs/ClusteringSearchResponse.md)
 - [ClusteringThreshold](docs/ClusteringThreshold.md)
 ...
 - [From](docs/From.md)
 - [From1](docs/From1.md)
 - [FromRank](docs/FromRank.md)
 - [HTTPValidationError](docs/HTTPValidationError.md)
 - [IncludeNlpData](docs/IncludeNlpData.md)
 - [IsHeadline](docs/IsHeadline.md)
 - [IsOpinion](docs/IsOpinion.md)
 - [IsPaidContent](docs/IsPaidContent.md)
 ...
 - [To](docs/To.md)
 - [To1](docs/To1.md)
 - [ToRank](docs/ToRank.md)
 - [ValidationError](docs/ValidationError.md)
 - [WordCountMax](docs/WordCountMax.md)
 - [WordCountMin](docs/WordCountMin.md)
